Shader "Unlit/rotacoes_shad"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                v2f o;
                v.vertex.xyz = rotGeral(v.vertex.xyz,_Time.w*10,_slidePitch,_slideRoll);
        ...
        Pass
        {
            ...
            {
                v2f o;
                v.vertex.xyz = rotGeral(v.vertex.xyz, _slideyaw,_Time.w*10,_slideRoll);
                o.vertex = UnityObjectToClipPos(v.vertex);
                o.uv = TRANSFORM_TEX(v.uv, _MainTex);
                return o;
            }
        ...
        Pass
        {
            ...
            {
                v2f o;
                v.vertex.xyz = rotGeral(v.vertex.xyz, _slideyaw,_slidePitch,_Time.w*10);
                o.vertex = UnityObjectToClipPos(v.vertex);
                o.uv = TRANSFORM_TEX(v.uv, _MainTex);
                return o;
            }
